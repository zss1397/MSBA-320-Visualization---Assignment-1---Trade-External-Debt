...
def load_and_process_data():
    try:
        ...
        infra_df = pd.read_csv("https://raw.githubusercontent.com/zss1397/MSBA-320-Visualization---Assignment-1---Trade-External-Debt/main/85ad3210ab85ae76a878453fad9ce16f_20240905_164730infra.csv")
        tourism_df = pd.read_csv("https://raw.githubusercontent.com/zss1397/MSBA-320-Visualization---Assignment-1---Trade-External-Debt/main/551015b5649368dd2612f795c2a9c2d8_20240902_115953tourism.csv")
        ...
        debt_df = pd.read_csv("https://raw.githubusercontent.com/zss1397/MSBA-320-Visualization---Assignment-1---Trade-External-Debt/main/ec4c40221073bbdf6f75b6c6127249c3_20240905_173222%20%20external%20debt.csv")
        ...
        st.info("Using fallback data with real values from your datasets...")
        
        # Fallback to embedded data with your real values
        road_conditions = pd.DataFrame({
            'Road Type': ['Main Roads', 'Secondary Roads', 'Agricultural Roads'],
            'Good': [122, 60, 17],
...
with st.expander("📊 Data Source Information"):
    ...
    **Real Data Values:**
    - Total Commercial Institutions: 42,436 (38,940 small, 2,612 medium, 884 large)
    - Tourism Facilities: 6,146 total (2,744 restaurants, 2,375 cafes, 383 hotels, 644 guesthouses)
    - Transportation: Taxis serve 746 towns, Vans 292 towns, Buses 125 towns
    - Infrastructure: 881 towns analyzed for road conditions
    """)
